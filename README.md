...
Files: shell.c - the actual implementation of the shell functions.h - header file where commands are parsed, separate processes are created, and the commands are executed Makefile - use 'make' to compile and 'make clean' remove executables and object files. README.md - this file
